...
class Model():
    ...
    def _create_model(self):
        ...
        W0 = tf.get_variable(name='W0', shape=[44, 32], initializer = tf.contrib.layers.variance_scaling_initializer())
        W1 = tf.get_variable(name='W1', shape=[32, 23], initializer = tf.contrib.layers.variance_scaling_initializer())
